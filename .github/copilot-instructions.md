...
_Last synced: 2026-07-06T23:40:07.331Z._
...
- `c:\temp\dom\.vscode\mcp.json` _(workspace: dom)_ — _file missing_

_No active workspace servers in mcp.json._

#### User MCP

- `C:\Users\C872969\AppData\Roaming\Code\User\mcp.json` — _servers defined_

| Server id | Kind | Detail |
|-----------|------|--------|
| atlassian | http | https://mcp.atlassian.com/v1/mcp |
| snyk | stdio | C:\Users\C872969\AppData\Local\snyk\vscode-cli\snyk-win.exe mcp -t stdio |
...
- **snyk-rules** — `C:\Users\C872969\.cursor\skills\snyk-rules` — After making any code changes, ensure best security practices are met
