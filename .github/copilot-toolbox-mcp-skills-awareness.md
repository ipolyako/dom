...
_Generated: 2026-07-06T23:40:07.319Z_
...
Workspace `mcp.json` _(folder: dom)_

- **c:\temp\dom\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\C872969\AppData\Roaming\Code\User\mcp.json** — _File exists — servers defined_
...
- **snyk-rules** — `C:\Users\C872969\.cursor\skills\snyk-rules`
